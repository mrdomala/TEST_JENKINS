...
import art.cucumber.io.pages.login_uspwd_ar;
...
public class login_uspwd_ar_details {
	...
	public void user_clicks_on_the_Arabic_language_hyperlink() throws Exception {
		loginuspwd = new login_uspwd_ar(driver);
		loginuspwd.ClickonArabic();
	...
	@Then("User enter pword as {string}")
	...
	@Then("Clicks Loginn")
	public void Clicks_Loginn() throws Exception {
	   loginuspwd.Login_button();
	}
	
	@Then("User enters Otp_0 as {string}")
	...
	@Then("User enters Otp_1 as {string}")
	...
	@Then("User enters Otp_2 as {string}")
	...
	@Then("User enters Otp_3 as {string}")
